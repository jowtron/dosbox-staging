...
std::vector<VideoModeBlock> ModeList_VGA = {
  //  mode    type     sw    sh    tw  th  cw ch  pt pstart    plength htot  vtot  hde  vde    special flags
	...
	// =========================================================================
	// HD and widescreen VESA modes
	// Timings copied from DOSBox-X: https://github.com/joncampbell123/dosbox-x
	// Source file: src/ints/int10_modes.cpp
	// License: GPL-2.0-or-later (same as DOSBox Staging)
	//
	// The 1400x1050 8/15/16-bpp modes are renumbered from DOSBox-X's
	// 0x230-0x232 to 0x251-0x253 because Staging already uses those
	// numbers for 132-column text modes. All entries carry HD_MODE so
	// they can be hidden via 'allow_hd_vesa_modes = off'.
	// =========================================================================

	// 720x480 3:2 modes (DVD resolution)
	{ 0x21B,  M_LIN4,  720,  480,  90, 30, 8, 16, 1, 0xA0000, 0x10000, 132,  525,  90,  480,                            HD_MODE},
	{ 0x21C,  M_LIN8,  720,  480,  90, 30, 8, 16, 1, 0xA0000, 0x10000, 132,  525,  90,  480,                            HD_MODE},
	{ 0x21D, M_LIN15,  720,  480,  90, 30, 8, 16, 1, 0xA0000, 0x10000, 264,  525, 180,  480,                            HD_MODE},
	{ 0x21E, M_LIN16,  720,  480,  90, 30, 8, 16, 1, 0xA0000, 0x10000, 264,  525, 180,  480,                            HD_MODE},
	{ 0x21F, M_LIN32,  720,  480,  90, 30, 8, 16, 1, 0xA0000, 0x10000, 132,  525,  90,  480,                            HD_MODE},

	// 1280x800 16:10 modes (common laptop resolution)
	{ 0x226,  M_LIN8, 1280,  800, 160, 50, 8, 16, 1, 0xA0000, 0x10000, 200,  880, 160,  800,                            HD_MODE},
	{ 0x227, M_LIN15, 1280,  800, 160, 50, 8, 16, 1, 0xA0000, 0x10000, 400,  880, 320,  800,                            HD_MODE},
	{ 0x228, M_LIN16, 1280,  800, 160, 50, 8, 16, 1, 0xA0000, 0x10000, 400,  880, 320,  800,                            HD_MODE},
	{ 0x229, M_LIN32, 1280,  800, 160, 50, 8, 16, 1, 0xA0000, 0x10000, 200,  880, 160,  800,                            HD_MODE},
	{ 0x300, M_LIN24, 1280,  800, 160, 50, 8, 16, 1, 0xA0000, 0x10000, 200,  880, 160,  800,                            HD_MODE},

	// 1280x960 4:3 modes
	{ 0x22A,  M_LIN4, 1280,  960, 160, 60, 8, 16, 1, 0xA0000, 0x10000, 200, 1020, 160,  960,                            HD_MODE},
	{ 0x22B,  M_LIN8, 1280,  960, 160, 60, 8, 16, 1, 0xA0000, 0x10000, 200, 1020, 160,  960,                            HD_MODE},
	{ 0x22C, M_LIN15, 1280,  960, 160, 60, 8, 16, 1, 0xA0000, 0x10000, 400, 1020, 320,  960,                            HD_MODE},
	{ 0x22D, M_LIN16, 1280,  960, 160, 60, 8, 16, 1, 0xA0000, 0x10000, 400, 1020, 320,  960,                            HD_MODE},
	{ 0x22E, M_LIN32, 1280,  960, 160, 60, 8, 16, 1, 0xA0000, 0x10000, 200, 1020, 160,  960,                            HD_MODE},
	{ 0x301, M_LIN24, 1280,  960, 160, 60, 8, 16, 1, 0xA0000, 0x10000, 200, 1020, 160,  960,                            HD_MODE},

	// 1440x900 16:10 widescreen modes
	{ 0x234,  M_LIN4, 1440,  900, 180, 56, 8, 16, 1, 0xA0000, 0x10000, 220,  980, 180,  900,                            HD_MODE},
	{ 0x235,  M_LIN8, 1440,  900, 180, 56, 8, 16, 1, 0xA0000, 0x10000, 220,  980, 180,  900,                            HD_MODE},
	{ 0x236, M_LIN15, 1440,  900, 180, 56, 8, 16, 1, 0xA0000, 0x10000, 440,  980, 360,  900,                            HD_MODE},
	{ 0x237, M_LIN16, 1440,  900, 180, 56, 8, 16, 1, 0xA0000, 0x10000, 440,  980, 360,  900,                            HD_MODE},
	{ 0x238, M_LIN32, 1440,  900, 180, 56, 8, 16, 1, 0xA0000, 0x10000, 220,  980, 180,  900,                            HD_MODE},

	// 1400x1050 4:3 modes (SXGA+ - common laptop resolution)
	{ 0x250,  M_LIN4, 1400, 1050, 175, 66, 8, 16, 1, 0xA0000, 0x10000, 220, 1100, 176, 1050,                            HD_MODE},
	{ 0x251,  M_LIN8, 1400, 1050, 175, 66, 8, 16, 1, 0xA0000, 0x10000, 220, 1100, 175, 1050,                            HD_MODE},
	{ 0x252, M_LIN15, 1400, 1050, 175, 66, 8, 16, 1, 0xA0000, 0x10000, 440, 1100, 350, 1050,                            HD_MODE},
	{ 0x253, M_LIN16, 1400, 1050, 175, 66, 8, 16, 1, 0xA0000, 0x10000, 440, 1100, 350, 1050,                            HD_MODE},
	{ 0x233, M_LIN32, 1400, 1050, 175, 66, 8, 16, 1, 0xA0000, 0x10000, 220, 1100, 175, 1050,                            HD_MODE},
	{ 0x303, M_LIN24, 1400, 1050, 175, 66, 8, 16, 1, 0xA0000, 0x10000, 220, 1100, 175, 1050,                            HD_MODE},

	// 1280x720 (720p) 16:9 HD modes
	{ 0x23D,  M_LIN4, 1280,  720, 160, 45, 8, 16, 1, 0xA0000, 0x10000, 176,  792, 160,  720,                            HD_MODE},
	{ 0x23E,  M_LIN8, 1280,  720, 160, 45, 8, 16, 1, 0xA0000, 0x10000, 176,  792, 160,  720,                            HD_MODE},
	{ 0x23F, M_LIN15, 1280,  720, 160, 45, 8, 16, 1, 0xA0000, 0x10000, 352,  792, 320,  720,                            HD_MODE},
	{ 0x240, M_LIN16, 1280,  720, 160, 45, 8, 16, 1, 0xA0000, 0x10000, 352,  792, 320,  720,                            HD_MODE},
	{ 0x241, M_LIN32, 1280,  720, 160, 45, 8, 16, 1, 0xA0000, 0x10000, 176,  792, 160,  720,                            HD_MODE},
	{ 0x302, M_LIN24, 1280,  720, 160, 45, 8, 16, 1, 0xA0000, 0x10000, 176,  792, 160,  720,                            HD_MODE},

	// 1920x1080 (1080p) 16:9 Full HD modes
	{ 0x242,  M_LIN4, 1920, 1080, 240, 67, 8, 16, 1, 0xA0000, 0x10000, 264, 1188, 240, 1080,                            HD_MODE},
	{ 0x243,  M_LIN8, 1920, 1080, 240, 67, 8, 16, 1, 0xA0000, 0x10000, 264, 1188, 240, 1080,                            HD_MODE},
	{ 0x244, M_LIN15, 1920, 1080, 240, 67, 8, 16, 1, 0xA0000, 0x10000, 528, 1188, 480, 1080,                            HD_MODE},
	{ 0x245, M_LIN16, 1920, 1080, 240, 67, 8, 16, 1, 0xA0000, 0x10000, 528, 1188, 480, 1080,                            HD_MODE},
	{ 0x246, M_LIN32, 1920, 1080, 240, 67, 8, 16, 1, 0xA0000, 0x10000, 264, 1188, 240, 1080,                            HD_MODE},
	{ 0x304, M_LIN24, 1920, 1080, 240, 67, 8, 16, 1, 0xA0000, 0x10000, 264, 1188, 240, 1080,                            HD_MODE},

	// 960x720 4:3 modes (4:3 at 720p vertical)
	{ 0x247,  M_LIN4,  960,  720, 160, 45, 8, 16, 1, 0xA0000, 0x10000, 144,  792, 120,  720,                            HD_MODE},
	{ 0x248,  M_LIN8,  960,  720, 160, 45, 8, 16, 1, 0xA0000, 0x10000, 144,  792, 120,  720,                            HD_MODE},
	{ 0x249, M_LIN15,  960,  720, 160, 45, 8, 16, 1, 0xA0000, 0x10000, 288,  792, 240,  720,                            HD_MODE},
	{ 0x24A, M_LIN16,  960,  720, 160, 45, 8, 16, 1, 0xA0000, 0x10000, 288,  792, 240,  720,                            HD_MODE},
	{ 0x24B, M_LIN32,  960,  720, 160, 45, 8, 16, 1, 0xA0000, 0x10000, 144,  792, 120,  720,                            HD_MODE},

	// 1440x1080 4:3 modes (4:3 at 1080p vertical)
	{ 0x24C,  M_LIN4, 1440, 1080, 240, 67, 8, 16, 1, 0xA0000, 0x10000, 200, 1188, 180, 1080,                            HD_MODE},
	{ 0x24D,  M_LIN8, 1440, 1080, 240, 67, 8, 16, 1, 0xA0000, 0x10000, 200, 1188, 180, 1080,                            HD_MODE},
	{ 0x24E, M_LIN15, 1440, 1080, 240, 67, 8, 16, 1, 0xA0000, 0x10000, 400, 1188, 360, 1080,                            HD_MODE},
	{ 0x24F, M_LIN16, 1440, 1080, 240, 67, 8, 16, 1, 0xA0000, 0x10000, 400, 1188, 360, 1080,                            HD_MODE},
	{ 0x2F0, M_LIN32, 1440, 1080, 240, 67, 8, 16, 1, 0xA0000, 0x10000, 200, 1188, 180, 1080,                            HD_MODE},

	// 1920x1440 4:3 modes
	{ 0x350,  M_LIN4, 1920, 1440, 240, 90, 8, 16, 1, 0xA0000, 0x10000, 264, 1584, 240, 1440,                            HD_MODE},
	{ 0x351,  M_LIN8, 1920, 1440, 240, 90, 8, 16, 1, 0xA0000, 0x10000, 264, 1584, 240, 1440,                            HD_MODE},
	{ 0x352, M_LIN15, 1920, 1440, 240, 90, 8, 16, 1, 0xA0000, 0x10000, 528, 1584, 480, 1440,                            HD_MODE},
	{ 0x353, M_LIN16, 1920, 1440, 240, 90, 8, 16, 1, 0xA0000, 0x10000, 528, 1584, 480, 1440,                            HD_MODE},
	{ 0x354, M_LIN32, 1920, 1440, 240, 90, 8, 16, 1, 0xA0000, 0x10000, 264, 1584, 240, 1440,                            HD_MODE},
	{ 0x355, M_LIN24, 1920, 1440, 240, 90, 8, 16, 1, 0xA0000, 0x10000, 264, 1584, 240, 1440,                            HD_MODE},
