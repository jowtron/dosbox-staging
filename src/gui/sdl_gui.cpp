...
// dosbox.cpp own the actual pause loop; here we just translate the hotkey
// press into the right transition.
//
...
// a focus-loss one (user-initiated pauses survive focus changes).
//
